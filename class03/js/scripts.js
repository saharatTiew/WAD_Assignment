...
function generateDataRow(item) {
    ...
    var dataRow =`<tr>
        <td class="data r data-quan-padding">${item.quantity}</td>
        <td class="data data-desc-padding">${item.description}</td>
        <td class="data r data-price-padding">${unitPrice}</td>
        <td class="data r data-price-padding">${item.amount}</td>
        </tr>`
    console.log({dataRow});
    return dataRow;
}
